...
public class ResearchFrame1 extends javax.swing.JFrame {
     ...
     */
    public ResearchFrame1(Connection conn, int user_id) throws SQLException {
        initComponents();
        this.conn = conn;
        ...
        posts = DBFetcher.fetchAllPosts(conn, 'R');
                ...
                newCategoryBox.addActionListener(new ActionListener(){
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        if(pickerFrom.getDate() != null && pickerTo.getDate() != null) {
                            ...
                            posts = DBFetcher.fetchAllPostsWithCategoriesAndDate(conn, tags, startDate, endDate, 'R');
                        } else {
                            posts = DBFetcher.fetchAllPostsWithCategories(conn, tags, 'R');
                        }
                        addPostsToPane(educationforumPosts, posts);
                    }
    ...
    private void initComponents() {
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(educationforumPosts, javax.swing.GroupLayout.DEFAULT_SIZE, 541, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(educationHeader, javax.swing.GroupLayout.DEFAULT_SIZE, 1206, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private void lblCreateNewPostMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblCreateNewPostMouseClicked
        ...
        new CreateNewPost(conn, user_id, "R").setVisible(true);
    ...
    private void lblGoBackMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblGoBackMouseClicked
        try {
            ...
            Logger.getLogger(ResearchFrame1.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void pickerFromActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pickerFromActionPerformed
        ...
        if(pickerFrom.getDate() != null && pickerTo.getDate() != null) {
            ...
            String endDate = sqlDateFormat.format(pickerTo.getDate());
            removePostsFromPane(educationforumPosts);
            posts = DBFetcher.fetchAllPostsWithCategoriesAndDate(conn, tags, startDate.toString(), endDate.toString(), 'R');
            addPostsToPane(educationforumPosts, posts);
        }
