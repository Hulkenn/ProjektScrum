...
public class SocialFrame extends javax.swing.JFrame {
     ...
     */
    public SocialFrame(Connection conn, int user_id) throws SQLException{
        initComponents();
        this.conn = conn;
        ...
        posts = DBFetcher.fetchAllPosts(conn, 'S');
                ...
                newCategoryBox.addActionListener(new ActionListener(){
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        if(pickerFrom.getDate() != null && pickerTo.getDate() != null) {
                            ...
                            posts = DBFetcher.fetchAllPostsWithCategoriesAndDate(conn, tags, startDate, endDate, 'S');
                        } else {
                            posts = DBFetcher.fetchAllPostsWithCategories(conn, tags, 'S');
                        }
                        addPostsToPane(educationforumPosts, posts);
                    }
    ...
    private void initComponents() {
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(educationforumPosts, javax.swing.GroupLayout.DEFAULT_SIZE, 545, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(educationHeader, javax.swing.GroupLayout.DEFAULT_SIZE, 1205, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private void lblCreateNewPostMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblCreateNewPostMouseClicked
        ...
        new CreateNewPost(conn, user_id, "S").setVisible(true);
    ...
    private void lblGoBackMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblGoBackMouseClicked
        try {
            ...
            Logger.getLogger(SocialFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void pickerFromActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pickerFromActionPerformed
        ...
        if(pickerFrom.getDate() != null && pickerTo.getDate() != null) {
            ...
            String endDate = sqlDateFormat.format(pickerTo.getDate());
            removePostsFromPane(educationforumPosts);
            posts = DBFetcher.fetchAllPostsWithCategoriesAndDate(conn, tags, startDate.toString(), endDate.toString(), 'S');
            addPostsToPane(educationforumPosts, posts);
        }
