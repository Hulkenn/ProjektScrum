...
public class RoomPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lbRoom1.setBackground(new java.awt.Color(50, 121, 184));
        lbRoom1.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        lbRoom1.setForeground(new java.awt.Color(0, 0, 0));
        ...
        lbRoom3.setBackground(new java.awt.Color(50, 121, 184));
        lbRoom3.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        lbRoom3.setForeground(new java.awt.Color(0, 0, 0));
        lbRoom3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lbRoom3.setText("Room 3");
        lbRoom3.setOpaque(true);

        lbRoom2.setBackground(new java.awt.Color(50, 121, 184));
        lbRoom2.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        lbRoom2.setForeground(new java.awt.Color(0, 0, 0));
        lbRoom2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lbRoom2.setText("Room 2");
        lbRoom2.setOpaque(true);

        lbRoom4.setBackground(new java.awt.Color(50, 121, 184));
        lbRoom4.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        lbRoom4.setForeground(new java.awt.Color(0, 0, 0));
        ...
        lbRoom5.setBackground(new java.awt.Color(50, 121, 184));
        lbRoom5.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        lbRoom5.setForeground(new java.awt.Color(0, 0, 0));
        lbRoom5.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lbRoom5.setText("Room 5");
        lbRoom5.setOpaque(true);

        lbRoom6.setBackground(new java.awt.Color(50, 121, 184));
        lbRoom6.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        lbRoom6.setForeground(new java.awt.Color(0, 0, 0));
        lbRoom6.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lbRoom6.setText("Room 6");
        lbRoom6.setOpaque(true);

        lbRoom7.setBackground(new java.awt.Color(50, 121, 184));
        lbRoom7.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        lbRoom7.setForeground(new java.awt.Color(0, 0, 0));
        lbRoom7.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lbRoom7.setText("Room 7");
        lbRoom7.setOpaque(true);

        lbRoom8.setBackground(new java.awt.Color(50, 121, 184));
        lbRoom8.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        lbRoom8.setForeground(new java.awt.Color(0, 0, 0));
